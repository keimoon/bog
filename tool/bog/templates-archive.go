...
// TemplatesArchive is archived variable for 'templates'
var TemplatesArchive = bog.NewArchive(map[string]bog.File{
	"/main.go.tmpl": vvv1413281467TemplatesMainGoTmpl,
	"/": vvv1413281467Templates,
	
}, false, false, "templates")
